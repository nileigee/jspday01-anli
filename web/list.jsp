...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/delSelectedServlet" method="post" id="selectedForm">
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                    ...
                    <c:if test="${pb.currentPage!=i}">
                        <li><a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${pb.currentPage+1}&rows=5&name=${condition.name[0]}&address=${condition.address[0]}&email=${condition.email[0]}">${i}</a></li>
                    </c:if>
                </c:forEach>
